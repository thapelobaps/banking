...
import UnifiedRightSidebar from '@/components/wallet/UnifiedRightSidebar';
import {
  getBankConnections,
...
export default async function Home() {
  ...
  return (
    <section className="kape-dashboard overview-dashboard">
      <div className="kape-page overview-page">
      ...
      <UnifiedRightSidebar
        ...
        ledgerBalanced={Boolean(reconciliation?.isBalanced)}
